 ...
 * @Route("/admin/option")
 */
class BackendOptionController extends AbstractController
{
    /**
    ...
    public function new(Request $request): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $em->persist($option);
            $em->flush();
            $this->addFlash('success', 'Option crée avec success');
    ...
    /**
     * @Route("/admin/option/edit/{id}", name="admin.option.edit", requirements={"id"="\d+"})
     * @param Request $request
     * @param Option $option
     * @return Response
     */
